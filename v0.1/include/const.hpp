...
inline constexpr unsigned int WORLD_COLS = 100; // Number of columns in the world
inline constexpr unsigned int WORLD_ROWS = 100; // Number of rows in the world

inline constexpr unsigned int WORLD_WIDTH = TILE_SIZE * WORLD_COLS; // World width in pixels (4800)
inline constexpr unsigned int WORLD_HEIGHT = TILE_SIZE * WORLD_ROWS; // World height in pixels (4800)